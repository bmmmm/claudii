...
MAN_COMMANDS=(on off status show sessionline sessions config debug search metrics restart components about version)
ALL_COMMANDS=(on off status show sessionline sessions config debug search metrics restart components about version help)
