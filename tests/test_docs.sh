...
MAN_COMMANDS=(on off status cc-statusline insomnii sessions sessions-inactive pin unpin cost trends tokens skills-cost config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard vibemap omlx vpnii gc resume cache)
ALL_COMMANDS=(on off status cc-statusline insomnii sessions sessions-inactive pin unpin cost trends tokens skills-cost config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard vibemap omlx vpnii gc resume cache help)
