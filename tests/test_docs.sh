...
MAN_COMMANDS=(on off status cc-statusline sessions sessions-inactive pin unpin cost trends config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard shame motivation rainbow)
ALL_COMMANDS=(on off status cc-statusline sessions sessions-inactive pin unpin cost trends config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard shame motivation rainbow help)
