...
MAN_COMMANDS=(on off status cc-statusline insomnii sessions sessions-inactive session pin unpin cost trends tokens tools limits skills-cost config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard vibemap omlx vpnii gc resume cache)
ALL_COMMANDS=(on off status cc-statusline insomnii sessions sessions-inactive session pin unpin cost trends tokens tools limits skills-cost config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard vibemap omlx vpnii gc resume cache help)
