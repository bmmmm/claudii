...
MAN_COMMANDS=(on off status cc-statusline insomnii sessions sessions-inactive pin unpin cost trends config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard)
ALL_COMMANDS=(on off status cc-statusline insomnii sessions sessions-inactive pin unpin cost trends config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard help)
...
SL_SEGMENTS=(
  ...
  api-duration burn-eta pace cron delta-5h delta-7d cache-create session-name
