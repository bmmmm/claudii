...
MAN_COMMANDS=(on off status cc-statusline insomnii sessions sessions-inactive pin unpin cost trends skills-cost config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard)
ALL_COMMANDS=(on off status cc-statusline insomnii sessions sessions-inactive pin unpin cost trends skills-cost config search restart update explain layers version doctor agents changelog claudestatus session-dashboard dashboard help)
