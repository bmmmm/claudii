...
MAN_COMMANDS=(on off status show sessionline sessions config debug search metrics restart components about version doctor)
ALL_COMMANDS=(on off status show sessionline sessions config debug search metrics restart components about version doctor help)
